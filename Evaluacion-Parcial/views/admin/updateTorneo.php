...
<div class="mx-auto p-4">
    ...
    <div class="label">
        <div class="mb-3">
            <label for="id" class="form-label">ID del Torneo (:id) <?= $lstTorneo['id'] ?> </label>
            <input type="text" class="form-control" id="id" name="txtid" 
            value = "<?= $lstTorneo['id'] ?>" >
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="patrocinador" name="txtpatrocinador" cols = "30" rows = "2" >
        ...
        <div class="col-12">
            ...
            <a href="readAllTorneos.php" class = "btn btn-primary">Cancelar</a>
        </div>
