...
class ProductoController {
    ...
    public function store() : void {
        ...
        if ((float)($data ['precio_compra']) < 0 || (float)($data ['precio_venta']) < 0
         ...
         if ((float) $data ['precio_venta'] < (float) $data ['precio_compra']) {
            ...
            echo json_encode(['error' => 'el precio de venta no puede ser menor que el precio de compra']);
            return;
        }
 ...
 /* la clase de arriba es un controlador php encargado de manejar las operaciones con productos, incluyendo métodos para crear,
actualizar, eliminar y mostrar productos mientras se verifica la sesión. */ 
?>